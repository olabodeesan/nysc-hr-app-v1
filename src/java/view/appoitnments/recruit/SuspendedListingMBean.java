...
import service.appointment.recruit.SuspensionService;
 ...
 * @author IronHide
 */
public class SuspendedListingMBean implements Serializable{
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        if (isForInit) {
            countQueryBuilder.append(service.getSuspendedListClause());
