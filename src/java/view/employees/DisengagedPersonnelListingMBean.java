 ...
 * @author IronHide
 */
public class DisengagedPersonnelListingMBean implements Serializable {
    ...
    public DisengagedPersonnelListingMBean() {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        if (isForInit) {
            ...
            selectQueryBuilder.append(service.getDisengagedListClause()).append(service.getOrderClause());
