...
import service.setup.CadreService;
 ...
 * @author IronHide
 */
public class CadreMBean implements Serializable{

    private CadreDTO newRecord;
    private List<CadreDTO> recordList;
    private CadreDTO selectedRecord;
    private CadreDTO editRecord;
    ...
    private CadreService service;

    public CadreMBean() {
        service = new CadreService();
    ...
    public void createAction(ActionEvent event) {
        ...
        boolean validation_outcome = validator.validateCadre(context, newRecord);
    ...
    public void prepareUpdateByLink(String row_record_id) {
        if (!StringUtils.isBlank(row_record_id)) {
            try {
                editRecord = service.getCadre(row_record_id);
    ...
    public void updateAction(ActionEvent event) {
        ...
        RequestContext reqContext = RequestContext.getCurrentInstance();
        boolean validation_outcome = validator.validateCadre(context, editRecord);
        if (validation_outcome) {
            String activityDate = DateTimeUtils.getActivityDate();
            String currentUser = viewHelper.getAppUser().getUsername();
            ...
            try {
                boolean result = service.updateCadre(editRecord);
                if (result) {
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<CadreDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<CadreDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<CadreDTO> recordList) {
    ...
    public CadreDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new CadreDTO();
        }
        return newRecord;
    }

    public void setNewRecord(CadreDTO newRecord) {
        this.newRecord = newRecord;
    }

    public CadreDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(CadreDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public CadreDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new CadreDTO();
        }
        return editRecord;
    }

    public void setEditRecord(CadreDTO editRecord) {
