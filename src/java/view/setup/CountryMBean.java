...
import service.setup.CountryService;
...
public class CountryMBean implements Serializable {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        selectQueryBuilder.append("select d.record_id,d.description,d.continent,d.record_status,e.description as continent_name ")
    ...
    public void createAction(ActionEvent event) {
        ...
        boolean validation_outcome = validator.validateCountry(context, newRecord);
    ...
    public void prepareUpdateByLink(String row_record_id) {
        if (!StringUtils.isBlank(row_record_id)) {
            try {
                editRecord = service.getCountry(row_record_id);
    ...
    public void updateAction(ActionEvent event) {
        ...
        RequestContext reqContext = RequestContext.getCurrentInstance();
        boolean validation_outcome = validator.validateCountry(context, editRecord);
        if (validation_outcome) {
            String activityDate = DateTimeUtils.getActivityDate();
            String currentUser = viewHelper.getAppUser().getUsername();
            ...
            try {
                boolean result = service.updateCountry(editRecord);
                if (result) {
    ...
    public void searchAction(ActionEvent event) {
        ...
        if (!StringUtils.isBlank(srchContinent)) {
            criteria.add("d.continent = " + "'" + ViewHelper.fixSqlFieldValue(srchContinent) + "' ");
        }
    ...
    public String getSrchContinent() {
        return srchContinent;
    }

    public void setSrchContinent(String srchContinent) {
        this.srchContinent = srchContinent;
    }
