 ...
 */
package view.reports.promotion;
...
import service.promotion.PromotionProposalReportService;
 ...
 * @author IronHide
 */
public class PromotionProposalMBean implements Serializable{
    ...
    private final PromotionProposalReportService service;

    public PromotionProposalMBean() {
        service = new PromotionProposalReportService();
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        if (isForInit) {
            selectQueryBuilder.append(service.getCompulsoryWhereClause())
                    .append(service.getOrderClause());
    ...
    public void searchAction(ActionEvent event) {
        ...
        //compulsory criteria        
        criteria.add(service.getCompulsoryWhereClause());
        ...
        if (criteria.isEmpty()) {
            ...
            selectQueryBuilder.append(service.getOrderClause());
    ...
    private void fillResults() {
        ...
        //System.out.print(currentSelectQuery);
