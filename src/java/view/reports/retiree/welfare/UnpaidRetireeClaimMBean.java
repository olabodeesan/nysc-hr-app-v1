 ...
 * @author nysc-ict-11
 */
public class UnpaidRetireeClaimMBean implements Serializable {
    ...
    public UnpaidRetireeClaimMBean() {
    ...
    private void fillResults() {
        try {
            //  recordDto = service.getUnpaidRetireeClaimReport();
        } catch (Exception ex) {
    ...
    public void searchAction(ActionEvent ev) {
        ...
        try {
            recordDto = service.getUnpaidRetireeClaimReport(searchStartDateStr, searchEndDateStr);
        } catch (Exception ex) {
