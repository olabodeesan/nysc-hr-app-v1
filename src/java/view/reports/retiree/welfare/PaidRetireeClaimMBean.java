 ...
 * @author nysc-ict-11
 */
public class PaidRetireeClaimMBean implements Serializable {
    ...
    private void fillResults() {
        try {
            recordDto = service.getPaidRetireeClaimReport(searchStartDateStr, searchEndDateStr);
        } catch (Exception ex) {
