 ...
 */
public class UnpaidTransferClaimMBean implements Serializable {
    ...
    public UnpaidTransferClaimMBean() {
    ...
    private void fillResults() {
        try {
            //  recordDto = service.getUnpaidTransferClaimReport();
        } catch (Exception ex) {
    ...
    public void searchAction(ActionEvent ev) {
        ...
        try {
            recordDto = service.getUnpaidTransferClaimReport(searchStartDateStr, searchEndDateStr);
        } catch (Exception ex) {
