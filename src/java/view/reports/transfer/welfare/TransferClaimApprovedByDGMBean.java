...
public class TransferClaimApprovedByDGMBean implements Serializable {
    ...
    public TransferClaimApprovedByDGMBean() {
    ...
    private void fillResults() {
        try {
          //  recordDto = service.getTransferClaimApprovedByDGReport();
        } catch (Exception ex) {
      ...
      public void searchAction(ActionEvent ev) {
        ...
        try {
            recordDto = service.getTransferClaimApprovedByDGReport(searchStartDateStr, searchEndDateStr);
        } catch (Exception ex) {
