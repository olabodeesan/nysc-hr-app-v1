 ...
 */
public class PaidTransferClaimMBean implements Serializable {
    ...
    private void fillResults() {
        try {
            //   recordDto = service.getPaidTransferClaimReport();
        } catch (Exception ex) {
    ...
    public void searchAction(ActionEvent ev) {
        ...
        try {
            recordDto = service.getPaidTransferClaimReport(searchStartDateStr, searchEndDateStr);
        } catch (Exception ex) {
