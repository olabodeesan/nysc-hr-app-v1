...
import service.reports.DisciplineReportService;
 ...
 * @author IronHide
 */
public class PresentlyDisciplinedReportMBean implements Serializable{
    ...
    private final DisciplineReportService service;

    public PresentlyDisciplinedReportMBean() {
        service = new DisciplineReportService();
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        if (isForInit) {
            selectQueryBuilder.append(service.getDisciplinedClause()).append(" order by e._temp_sort  ");
    ...
    public void searchAction(ActionEvent event) {
        ...
        //compulsory criteria
        criteria.add(service.getDisciplinedClause());
