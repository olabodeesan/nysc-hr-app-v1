 ...
 * @author IronHide
 */
public class PositionAppointmentService implements Serializable{
    
    private ServiceUtil serviceUtil;
    private DBUtil dBUtil;

    public PositionAppointmentService() {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<PositionAppointmentDTO> dto_list = new ArrayList<>();
        PositionAppointmentDTO dto = null;
        ...
        try {
            ...
            while (result_set.next()) {
                ...
                dto = new PositionAppointmentDTO();
    ...
    public PositionAppointmentDTO getPositionAppointment(String recordId)
            throws AppException {

        PositionAppointmentDTO result = null;
        ...
        try {
            ...
            strBuilder.append("select record_id,description,record_status from setup_position_appointment where record_id=?");
            ...
            if (found) {
                result = new PositionAppointmentDTO();
    ...
    public boolean createPositionAppointment(PositionAppointmentDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_position_appointment where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_position_appointment ")
    ...
    public boolean updatePositionAppointment(PositionAppointmentDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_position_appointment where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_position_appointment ")
                    .append(" set ")
                    .append("description=?")
