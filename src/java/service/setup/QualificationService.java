 ...
 * @author IronHide
 */
public class QualificationService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<QualificationDTO> dto_list = new ArrayList<>();
        ...
        try {
            ...
            while (result_set.next()) {
                ...
                dto.setInstitutionType(result_set.getString("institution_type"));
                dto.setInstitutionTypeDesc(result_set.getString("_institution_type"));
                dto.setAbbreviation(result_set.getString("abbreviation"));
    ...
    public QualificationDTO getQualification(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.abbreviation,d.description,d.record_status,d.institution_type ")
                    .append(",i.description as _institution_type")
                    .append(" from setup_qualifications d  ")
                    .append(" join setup_institution_types i on (d.institution_type=i.record_id)")
            ...
            if (found) {
                ...
                result.setInstitutionType(result_set.getString("institution_type"));
                result.setInstitutionTypeDesc(result_set.getString("_institution_type"));
                result.setAbbreviation(result_set.getString("abbreviation"));
    ...
    public boolean createQualification(QualificationDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_qualifications where abbreviation=?";

            prep_stmt = db_conn.prepareStatement(check_query);
            prep_stmt.setString(1, dto.getAbbreviation());
            result_set = prep_stmt.executeQuery();
            ...
            check_query = "select record_id from setup_qualifications where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_qualifications ")
                    .append("(description,abbreviation,record_status,created,created_by,last_mod,last_mod_by,institution_type)")
                    .append(" values (?,?,?,?,?,?,?,?)");
            ...
            prep_stmt.setString(2, serviceUtil.getValueOrEmpty(dto.getAbbreviation()));
            ...
            prep_stmt.setString(8, serviceUtil.getValueOrEmpty(dto.getInstitutionType()));
    ...
    public boolean updateQualification(QualificationDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate code
            String check_query = "select record_id from setup_qualifications where abbreviation=? and record_id<>?";
            ...
            //check duplicate name
            check_query = "select record_id from setup_qualifications where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_qualifications ")
                    .append(" set ")
                    .append("abbreviation=?")
                    .append(",description=?")
            ...
            prep_stmt.setString(1, serviceUtil.getValueOrEmpty(dto.getAbbreviation()));
            ...
            prep_stmt.setString(6, serviceUtil.getValueOrEmpty(dto.getInstitutionType()));
            prep_stmt.setString(7, serviceUtil.getValueOrEmpty(dto.getRecordId()));
