 ...
 * @author IronHide
 */
public class CadreService implements Serializable{
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<CadreDTO> dto_list = new ArrayList<>();
        CadreDTO dto = null;
    ...
    public CadreDTO getCadre(String recordId)
            throws AppException {

        CadreDTO result = null;
        ...
        try {
            ...
            strBuilder.append("select record_id,description,record_status from setup_cadre where record_id=?");
    ...
    public boolean createCadre(CadreDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_cadre where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_cadre ")
    ...
    public boolean updateCadre(CadreDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_cadre where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_cadre ")
                    .append(" set ")
                    .append("description=?")
