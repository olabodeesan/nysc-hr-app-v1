 ...
 */
public class InstitutionTypeValidator implements Serializable {

    public InstitutionTypeValidator() {
    }
    
     public boolean validateNew(FacesContext context, InstitutionTypeDTO dto) {
        boolean result = true;
