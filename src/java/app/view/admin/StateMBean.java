 ...
 */
public class StateMBean implements Serializable {

    private StateDTO newRecord;
    private List<StateDTO> recordList;
    private StateDTO selectedRecord;
    private StateDTO editRecord;
    ...
    /**
     * Creates a new instance of StateMBean
     */
    public StateMBean() {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_states d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_states d ")
                .append("where ");
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_STATE);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<StateDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<StateDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<StateDTO> recordList) {
    ...
    public void setNewRecord(StateDTO newRecord) {
        this.newRecord = newRecord;
    }

    public StateDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(StateDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public StateDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new StateDTO();
        }
        return editRecord;
    }

    public void setEditRecord(StateDTO editRecord) {
