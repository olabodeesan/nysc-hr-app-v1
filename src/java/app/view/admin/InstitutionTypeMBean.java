...
import app.dto.InstitutionTypeDTO;
import app.exceptions.AppException;
import app.service.admin.InstitutionTypeService;
import app.view.utils.AppConstants;
import app.view.utils.DateTimeUtils;
import app.view.utils.ViewHelper;
import app.view.validation.InstitutionTypeValidator;
 ...
 */
public class InstitutionTypeMBean implements Serializable {

    private InstitutionTypeDTO newRecord;
    private List<InstitutionTypeDTO> recordList;
    private InstitutionTypeDTO selectedRecord;
    private InstitutionTypeDTO editRecord;
    ...
    private InstitutionTypeService service;

    /**
     * Creates a new instance of InstitutionTypeMBean
     */
    public InstitutionTypeMBean() {
        service = new InstitutionTypeService();
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_institution_types d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_institution_types d ")
                .append("where ");
    ...
    public void createAction(ActionEvent event) {
        ...
        InstitutionTypeValidator validator = new InstitutionTypeValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_INST_TYPE);
    ...
    public void preparenewAction() {
        newRecord = new InstitutionTypeDTO();
    }
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<InstitutionTypeDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<InstitutionTypeDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<InstitutionTypeDTO> recordList) {
    ...
    public InstitutionTypeDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new InstitutionTypeDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(InstitutionTypeDTO newRecord) {
        this.newRecord = newRecord;
    }

    public InstitutionTypeDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(InstitutionTypeDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public InstitutionTypeDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new InstitutionTypeDTO();
        }
        return editRecord;
    }

    public void setEditRecord(InstitutionTypeDTO editRecord) {
