...
public class LocationMBean implements Serializable {
    ...
    private LocationDTO newRecord;
    private List<LocationDTO> recordList;
    private LocationDTO selectedRecord;
    private LocationDTO editRecord;
    ...
    /**
     * Creates a new instance of LocationMBean
     */
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_locations d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_locations d ")
                .append("where ");
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_LOCATION);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<LocationDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<LocationDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<LocationDTO> recordList) {
    ...
    public LocationDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new LocationDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(LocationDTO newRecord) {
        this.newRecord = newRecord;
    }

    public LocationDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(LocationDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public LocationDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new LocationDTO();
        }
        return editRecord;
    }

    public void setEditRecord(LocationDTO editRecord) {
