 ...
 */
public class AppointmentMBean implements Serializable {

    private AppointmentDTO newRecord;
    private List<AppointmentDTO> recordList;
    private AppointmentDTO selectedRecord;
    private AppointmentDTO editRecord;
    ...
    /**
     * Creates a new instance of AppointmentMBean
     */
    public AppointmentMBean() {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_position_appointment d ")
                .append("where ");
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_APPOINTMENT);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<AppointmentDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<AppointmentDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<AppointmentDTO> recordList) {
    ...
    public AppointmentDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new AppointmentDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(AppointmentDTO newRecord) {
        this.newRecord = newRecord;
    }

    public AppointmentDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(AppointmentDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public AppointmentDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new AppointmentDTO();
        }
        return editRecord;
    }

    public void setEditRecord(AppointmentDTO editRecord) {
