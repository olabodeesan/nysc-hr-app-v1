 ...
 */
public class GradeStepMBean implements Serializable {

    private GradeStepDTO newRecord;
    private List<GradeStepDTO> recordList;
    private GradeStepDTO selectedRecord;
    private GradeStepDTO editRecord;
    ...
    private GradeStepService service;

    /**
     * Creates a new instance of CadreMBean
     */
    public GradeStepMBean() {
        service = new GradeStepService();
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_grade_steps d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_grade_steps d ")
                .append("where ");
    ...
    public void createAction(ActionEvent event) {
        ...
        GradeStepValidator validator = new GradeStepValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_GRADE_STEP);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<GradeStepDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<GradeStepDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<GradeStepDTO> recordList) {
    ...
    public GradeStepDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new GradeStepDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(GradeStepDTO newRecord) {
        this.newRecord = newRecord;
    }

    public GradeStepDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(GradeStepDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public GradeStepDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new GradeStepDTO();
        }
        return editRecord;
    }

    public void setEditRecord(GradeStepDTO editRecord) {
