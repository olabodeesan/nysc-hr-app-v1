...
import app.dto.MaritalStatusDTO;
import app.exceptions.AppException;
import app.service.admin.MaritalStatusService;
import app.view.utils.AppConstants;
import app.view.utils.DateTimeUtils;
import app.view.utils.ViewHelper;
import app.view.validation.MaritalStatusValidator;
 ...
 */
public class MaritalStatusMBean implements Serializable {

    private MaritalStatusDTO newRecord;
    private List<MaritalStatusDTO> recordList;
    private MaritalStatusDTO selectedRecord;
    private MaritalStatusDTO editRecord;
    ...
    /**
     * Creates a new instance of MaritalStatusMBean
     */
    public MaritalStatusMBean() {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_marital_status d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_marital_status d ")
                .append("where ");
    ...
    public void createAction(ActionEvent event) {
        ...
        MaritalStatusValidator validator = new MaritalStatusValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_MARITAL_STATUS);
    ...
    public void preparenewAction() {
        newRecord = new MaritalStatusDTO();
    }
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<MaritalStatusDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<MaritalStatusDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<MaritalStatusDTO> recordList) {
    ...
    public MaritalStatusDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new MaritalStatusDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(MaritalStatusDTO newRecord) {
        this.newRecord = newRecord;
    }

    public MaritalStatusDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(MaritalStatusDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public MaritalStatusDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new MaritalStatusDTO();
        }
        return editRecord;
    }

    public void setEditRecord(MaritalStatusDTO editRecord) {
