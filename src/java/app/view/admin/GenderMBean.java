 ...
 */
public class GenderMBean implements Serializable {

    private GenderDTO newRecord;
    private List<GenderDTO> recordList;
    private GenderDTO selectedRecord;
    private GenderDTO editRecord;
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_gender d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_gender d ")
                .append("where ");
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_GENDER);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<GenderDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<GenderDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<GenderDTO> recordList) {
    ...
    public void setNewRecord(GenderDTO newRecord) {
        this.newRecord = newRecord;
    }

    public GenderDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(GenderDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public GenderDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new GenderDTO();
        }
        return editRecord;
    }

    public void setEditRecord(GenderDTO editRecord) {
