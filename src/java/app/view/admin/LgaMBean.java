 ...
 */
public class LgaMBean implements Serializable {

    private LgaDTO newRecord;
    private List<LgaDTO> recordList;
    private LgaDTO selectedRecord;
    private LgaDTO editRecord;
    ...
    private LgaService service;

    /**
     * Creates a new instance of LgaMBean
     */
    public LgaMBean() {
        service = new LgaService();
    ...
    public void createAction(ActionEvent event) {
        ...
        LgaValidator validator = new LgaValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_LGA);
    ...
    public void searchAction(ActionEvent event) {
        ...
        if (!StringUtils.isBlank(srchState)) {
            criteria.add("d.state_id like " + "'" + ViewHelper.fixSqlFieldValue(srchState) + "' ");
        }
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<LgaDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<LgaDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<LgaDTO> recordList) {
    ...
    public void setNewRecord(LgaDTO newRecord) {
        this.newRecord = newRecord;
    }

    public LgaDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(LgaDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public LgaDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new LgaDTO();
        }
        return editRecord;
    }

    public void setEditRecord(LgaDTO editRecord) {
