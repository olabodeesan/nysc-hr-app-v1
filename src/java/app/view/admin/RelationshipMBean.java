...
import app.dto.RelationshipDTO;
import app.exceptions.AppException;
import app.service.admin.RelationshipService;
import app.view.utils.AppConstants;
import app.view.utils.DateTimeUtils;
import app.view.utils.ViewHelper;
import app.view.validation.RelationshipValidator;
 ...
 */
public class RelationshipMBean implements Serializable {

    private RelationshipDTO newRecord;
    private List<RelationshipDTO> recordList;
    private RelationshipDTO selectedRecord;
    private RelationshipDTO editRecord;
    ...
    /**
     * Creates a new instance of RelationshipMBean
     */
    public RelationshipMBean() {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_relationships d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_relationships d ")
                .append("where ");
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_RELATIONSHIP);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<RelationshipDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<RelationshipDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<RelationshipDTO> recordList) {
    ...
    public RelationshipDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new RelationshipDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(RelationshipDTO newRecord) {
        this.newRecord = newRecord;
    }

    public RelationshipDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(RelationshipDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public RelationshipDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new RelationshipDTO();
        }
        return editRecord;
    }

    public void setEditRecord(RelationshipDTO editRecord) {
