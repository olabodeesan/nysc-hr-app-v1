...
public class RankMBean implements Serializable {
    ...
    private RankDTO newRecord;
    private List<RankDTO> recordList;
    private RankDTO selectedRecord;
    private RankDTO editRecord;
    ...
    /**
     * Creates a new instance of RankMBean
     */
    public RankMBean() {
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_rank d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_rank d ")
                .append("where ");
    ...
    public void createAction(ActionEvent event) {
        ...
        RankValidator validator = new RankValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_RANK);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<RankDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<RankDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<RankDTO> recordList) {
    ...
    public void setNewRecord(RankDTO newRecord) {
        this.newRecord = newRecord;
    }

    public RankDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(RankDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public RankDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new RankDTO();
        }
        return editRecord;
    }

    public void setEditRecord(RankDTO editRecord) {
