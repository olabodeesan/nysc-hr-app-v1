...
import app.dto.GradeLevelDTO;
import app.exceptions.AppException;
import app.service.admin.GradeLevelService;
import app.view.utils.AppConstants;
import app.view.utils.DateTimeUtils;
import app.view.utils.ViewHelper;
import app.view.validation.GradeLevelValidator;
 ...
 */
public class GradeLevelMBean implements Serializable {

    private GradeLevelDTO newRecord;
    private List<GradeLevelDTO> recordList;
    private GradeLevelDTO selectedRecord;
    private GradeLevelDTO editRecord;
    ...
    /**
     * Creates a new instance of CadreMBean
     */
    public GradeLevelMBean() {
        service = new GradeLevelService();
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        countQueryBuilder.append("select count(d.record_id) from setup_grade_levels d ")
                .append("where ");

        selectQueryBuilder = new StringBuilder();
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_grade_levels d ")
                .append("where ");
    ...
    public void createAction(ActionEvent event) {
        ...
        GradeLevelValidator validator = new GradeLevelValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_GRADE_LEVEL);
    ...
    private void fillResults() {
        ...
        try {
            ...
            recordList = (List<GradeLevelDTO>) result.get(AppConstants.RECORD_LIST);
    ...
    public List<GradeLevelDTO> getRecordList() {
        if (recordList == null) {
    ...
    public void setRecordList(List<GradeLevelDTO> recordList) {
    ...
    public GradeLevelDTO getNewRecord() {
        if (newRecord == null) {
            newRecord = new GradeLevelDTO();
        }
        return newRecord;
    ...
    public void setNewRecord(GradeLevelDTO newRecord) {
        this.newRecord = newRecord;
    }

    public GradeLevelDTO getSelectedRecord() {
        return selectedRecord;
    }

    public void setSelectedRecord(GradeLevelDTO selectedRecord) {
        this.selectedRecord = selectedRecord;
    }

    public GradeLevelDTO getEditRecord() {
        if (editRecord == null) {
            editRecord = new GradeLevelDTO();
        }
        return editRecord;
    }

    public void setEditRecord(GradeLevelDTO editRecord) {
