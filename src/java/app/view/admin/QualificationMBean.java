 ...
 */
    ...
    /**
     * Creates a new instance of QualificationMBean
     */
    ...
    private void initSearchQuery(boolean isForInit, boolean isForSearch, boolean shouldFetch) {
        ...
        selectQueryBuilder.append("select d.record_id,d.description")
                .append(" ,d.record_status from setup_qualifications d ")
                .append("where ");
    ...
    public void createAction(ActionEvent event) {
        ...
        QualificationValidator validator = new QualificationValidator();
        ...
        if (validation_outcome) {
            ...
            try {
                ...
                if (result) {
                    ...
                    viewHelper.removeApplicationAttribute(AppConstants.APP_SCOPE_QUALIFICATION);
