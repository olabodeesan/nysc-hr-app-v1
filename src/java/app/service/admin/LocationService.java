...
public class LocationService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<LocationDTO> dto_list = new ArrayList<>();
    ...
    public LocationDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_locations d where d.record_id=?");
    ...
    public boolean createRecord(LocationDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_locations where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_locations ")
    ...
    public boolean updateRecord(LocationDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_locations where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_locations ")
                    .append(" set ")
                    .append("description=?")
