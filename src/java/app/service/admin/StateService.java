...
public class StateService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<StateDTO> dto_list = new ArrayList<>();
        StateDTO dto = null;
    ...
    public StateDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_states d where d.record_id=?");
    ...
    public boolean createRecord(StateDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_states where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_states ")
    ...
    public boolean updateRecord(StateDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_states where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_states ")
                    .append(" set ")
                    .append("description=?")
