...
public class CountryService implements Serializable {
    ...
    public CountryDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_countries d where d.record_id=?");
    ...
    public boolean createRecord(CountryDTO dto)
            throws AppException {
    ...
    public boolean updateRecord(CountryDTO dto)
            throws AppException {
