...
public class AppointmentService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<AppointmentDTO> dto_list = new ArrayList<>();
    ...
    public AppointmentDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_position_appointment d where d.record_id=?");
    ...
    public boolean createRecord(AppointmentDTO dto)
            throws AppException {
    ...
    public boolean updateRecord(AppointmentDTO dto)
            throws AppException {
