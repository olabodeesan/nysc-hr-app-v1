 ...
 */
public class GradeLevelService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<GradeLevelDTO> dto_list = new ArrayList<>();
        GradeLevelDTO dto = null;
    ...
    public GradeLevelDTO getRecord(String recordId)
            throws AppException {

        GradeLevelDTO result = null;
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_grade_levels d where d.record_id=?");
    ...
    public boolean createRecord(GradeLevelDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_grade_levels where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_grade_levels ")
    ...
    public boolean updateRecord(GradeLevelDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_grade_levels where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_grade_levels ")
                    .append(" set ")
                    .append("description=?")
