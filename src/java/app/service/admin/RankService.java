...
public class RankService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<RankDTO> dto_list = new ArrayList<>();
        RankDTO dto = null;
    ...
    public RankDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_rank d where d.record_id=?");
    ...
    public boolean createRecord(RankDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_rank where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_rank ")
    ...
    public boolean updateRecord(RankDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_rank where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_rank ")
                    .append(" set ")
                    .append("description=?")
