...
public class DepartmentService implements Serializable {
    ...
    public DepartmentDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_departments d where d.record_id=?");
    ...
    public boolean createRecord(DepartmentDTO dto)
            throws AppException {
    ...
    public boolean updateRecord(DepartmentDTO dto)
            throws AppException {
