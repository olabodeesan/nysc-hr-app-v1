...
public class MaritalStatusService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<MaritalStatusDTO> dto_list = new ArrayList<>();
        MaritalStatusDTO dto = null;
    ...
    public MaritalStatusDTO getRecord(String recordId)
            throws AppException {

        MaritalStatusDTO result = null;
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_marital_status d where d.record_id=?");
    ...
    public boolean createRecord(MaritalStatusDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_marital_status where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_marital_status ")
    ...
    public boolean updateRecord(MaritalStatusDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_marital_status where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_marital_status ")
                    .append(" set ")
                    .append("description=?")
