...
public class RelationshipService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<RelationshipDTO> dto_list = new ArrayList<>();
        RelationshipDTO dto = null;
    ...
    public RelationshipDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_relationships d where d.record_id=?");
    ...
    public boolean createRecord(RelationshipDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_relationships where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_relationships ")
    ...
    public boolean updateRecord(RelationshipDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_relationships where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_relationships ")
                    .append(" set ")
                    .append("description=?")
