 ...
 */
public class InstitutionTypeService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<InstitutionTypeDTO> dto_list = new ArrayList<>();
        InstitutionTypeDTO dto = null;
    ...
    public InstitutionTypeDTO getRecord(String recordId)
            throws AppException {

        InstitutionTypeDTO result = null;
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_institution_types d where d.record_id=?");
    ...
    public boolean createRecord(InstitutionTypeDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_institution_types where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_institution_types ")
    ...
    public boolean updateRecord(InstitutionTypeDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_institution_types where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_institution_types ")
                    .append(" set ")
                    .append("description=?")
