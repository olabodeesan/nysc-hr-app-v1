...
public class CadreService implements Serializable {
    ...
    public CadreDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_cadre d where d.record_id=?");
    ...
    public boolean createRecord(CadreDTO dto)
            throws AppException {
    ...
    public boolean updateRecord(CadreDTO dto)
            throws AppException {
