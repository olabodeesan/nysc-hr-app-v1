...
public class QualificationService implements Serializable {
    ...
    public QualificationDTO getRecord(String recordId)
            throws AppException {
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_qualifications d where d.record_id=?");
    ...
    public boolean createRecord(QualificationDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_qualifications where description=?";
    ...
    public boolean updateRecord(QualificationDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_qualifications where description=? and record_id<>?";
