...
public class GenderService implements Serializable {
    ...
    public Map<String, Object> searchRecords(String countQuery, String selectQuery, int startRow, int pagesize)
        ...
        List<GenderDTO> dto_list = new ArrayList<>();
        GenderDTO dto = null;
    ...
    public GenderDTO getRecord(String recordId)
            throws AppException {

        GenderDTO result = null;
        ...
        try {
            ...
            strBuilder.append("select d.record_id,d.description,d.record_status")
                    .append(" from setup_gender d where d.record_id=?");
    ...
    public boolean createRecord(GenderDTO dto)
            throws AppException {
        ...
        try {
            ...
            String check_query = "select record_id from setup_gender where description=?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("insert into setup_gender ")
    ...
    public boolean updateRecord(GenderDTO dto)
            throws AppException {
        ...
        try {
            ...
            //check duplicate name
            String check_query = "select record_id from setup_gender where description=? and record_id<>?";
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("update setup_gender ")
                    .append(" set ")
                    .append("description=?")
